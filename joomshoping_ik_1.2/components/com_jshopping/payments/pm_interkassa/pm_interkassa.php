...
class pm_interkassa extends PaymentRoot
{
    ...
    $params = array(
        ...
        'ik_suc_u' => $protocol.$_SERVER['SERVER_NAME'].'/index.php?option=com_jshopping&controller=checkout&task=step7&act=return&js_paymentclass=pm_interkassa',
        'ik_fal_u' => $protocol.$_SERVER['SERVER_NAME'].'/index.php?option=com_jshopping&controller=checkout&task=step7&act=cancel&js_paymentclass=pm_interkassa',
        'ik_pnd_u' => $protocol.$_SERVER['SERVER_NAME'].'/index.php?option=com_jshopping&controller=checkout&task=step7&act=return&js_paymentclass=pm_interkassa',
        'ik_ia_u' => $protocol.$_SERVER['SERVER_NAME'].'/index.php?option=com_jshopping&controller=checkout&task=step7&act=notify&js_paymentclass=pm_interkassa&no_lang=1'
    );
...
?>
    ...
    <form id="paymentform" action="<?php print $action_url?>" name = "paymentform" method = "POST">
        ...
        <input type=hidden name="ik_pnd_u" value='<?php print $params['ik_pnd_u']; ?>'>
